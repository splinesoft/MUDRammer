...
screenshots_path "./AppStore/deliver/screenshots/"
...
ipa "./output/release/MUDRammer.ipa" # this can be used instead of the `do` block, if you prefer manually building the ipa file
